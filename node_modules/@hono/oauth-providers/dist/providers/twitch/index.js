...
async function revokeToken(client_id, token) {
  ...
  if (!res.ok) {
    try {
      ...
      throw new import_http_exception4.HTTPException(400, { message: `Token revocation failed with status: ${res.status}` });
    }
  }
  return true;
}
